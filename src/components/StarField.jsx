...
const stars = [
  // [cx, cy, dim, blur, speed]
  [4, 4, true, true, 3],
  [4, 44, true, false, 2],
  [36, 22, false, false, 2.5],
  // ... rest of your stars here
  [50, 146, true, true],
  [64, 43, true, true],
  [76, 30, true],
  [101, 116],
...
function Star({ blurId, point: [cx, cy, dim, blur, speed] }) {
  let groupRef = useRef()
  let ref = useRef()
  ...
  useEffect(() => {
    ...
    let animations = [
      animate(
        ref.current,
        { cx: direction === 'right' ? cx + speed * 100 : cx - speed * 100 },
        { duration: speed, delay, repeat: Infinity }
      ),
      animate(
        ref.current,
        {
